...
parser.add_argument('--minLabels', metavar='minL', default=2, type=int,  # 3
...
path_to_save = args.input
path_to_save = path_to_save.replace('original', 'predicted')
cv2.imwrite(path_to_save, im_target_rgb)
